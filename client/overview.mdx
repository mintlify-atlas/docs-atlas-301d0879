...
<CardGroup cols={1}>
  <Card title="useUser" icon="user" href="./use-user">
...
<CardGroup cols={1}>
  <Card title="getAccessToken" icon="key" href="./get-access-token">
    Fetch access tokens for calling external APIs from client components
  </Card>
  <Card title="withPageAuthRequired" icon="shield" href="./with-page-auth-required">
...
<CardGroup cols={1}>
  <Card title="Auth0Provider" icon="react" href="./auth0-provider">
...
<CardGroup cols={2}>
  <Card title="useUser Hook" icon="user" href="./use-user">
    Learn how to access user data in client components
  </Card>
  <Card title="Get Access Tokens" icon="key" href="./get-access-token">
    Fetch tokens for calling external APIs
  </Card>
  <Card title="Protect Pages" icon="shield" href="./with-page-auth-required">
